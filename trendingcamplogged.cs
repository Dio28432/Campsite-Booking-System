...
namespace campsite
{
    public partial class trendingcamplogged : Form
    {
        string usname;
        public trendingcamplogged()
        {
            InitializeComponent();
        }
        public trendingcamplogged(string ussname)
        {
            InitializeComponent();
            usname = ussname;
        }

        private void buttonaddtocart1tren_Click(object sender, EventArgs e)
        {
        ...
        private void buttonAddtocart2tren_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Added to cart");
            ...
            try
            {
                ...
                string query = $"INSERT INTO Mycart6 (Added_Items,Price,Uname) VALUES ('Yuru Campsite',12000,'{usname}');";
                SqlCommand cmd = new SqlCommand(query, conn);
                DataSet ds = new DataSet();
                SqlDataAdapter adp = new SqlDataAdapter(cmd);
                adp.Fill(ds);
        ...
        private void buttonAddtocart3tren_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Added to cart");
        ...
        private void buttonAddtocart4tren_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Added to cart");
